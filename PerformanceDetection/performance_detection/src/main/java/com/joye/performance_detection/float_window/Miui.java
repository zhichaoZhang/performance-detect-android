...
class Miui {
    ...
    private static List<IFloatView.PermissionCheckListener> mPermissionListenerList;
    private static IFloatView.PermissionCheckListener mPermissionListener;
     ...
     * Android6.0以下申请权限
     */
    static void req(final Context context, IFloatView.PermissionCheckListener permissionListener) {
        if (mPermissionListenerList == null) {
            mPermissionListenerList = new ArrayList<>();
            mPermissionListener = new IFloatView.PermissionCheckListener() {
                @Override
                public void onSuccess() {
                    for (IFloatView.PermissionCheckListener listener : mPermissionListenerList) {
                        listener.onSuccess();
                    }
