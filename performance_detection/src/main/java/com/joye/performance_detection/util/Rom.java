package com.joye.performance_detection.util;
...
public class Rom {
    ...
    private static final String ROM_SAMSUNG = "QIKU";
    private static final String ROM_ONEPLUS = "ONEPLUS";
    private static final String BRAND_EMUI_HONOR = "HONOR";
    private static final String BRAND_EMUI_HUAWEI = "HUAWEI";
    ...
    private static final String KEY_VERSION_ONEPLUS = "ro.oneplus.os.version";
